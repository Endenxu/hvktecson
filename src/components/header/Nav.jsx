...
const Nav = () => {
    ...
    return (
        <nav className={`navbar ${isNavbarVisible ? "sticky" : ""}`}>
            <div
                className={`header__nav-menu-overlay ${isMenuOpen ? "show" : ""}`}
                onClick={() => closeMenu(isMenuOpen, setIsMenuOpen)}
                onTouchStart={() => closeMenu(isMenuOpen, setIsMenuOpen)}
            ></div>
            <div className="header__nav-content">
                ...
                <ul className={`header__nav-menu ${isMenuOpen ? "show" : ""}`}>
                    ...
                    <li className="header__nav-item">
                        <div className="header__nav-social">
                            <a
                                ...
                                target="_blank"
                                aria-label="Get to know more about me on instagram"
                            >
                                <BsInstagram />
                            </a>
                        </div>
                        <div className="header__nav-social">
                            <a
                                ...
                                target="_blank"
                                aria-label="Get to know more about me on linkedin"
                            >
                                <BsLinkedin />
                            </a>
                        </div>
                        <div className="header__nav-social">
                            <a
                                ...
                                target="_blank"
                                aria-label="Get to know more about me on twitter"
                            >
                                <BsTwitter />
                            </a>
                        </div>
                        <div className="header__nav-social">
                            <a
                                ...
                                target="_blank"
                                aria-label="Get to know more about me on github"
                            >
                                <BsGithub />
                            </a>
                        </div>
                    ...
                    <li className="header__nav-item">
                        <small>&copy; Built & Designed by Kyle Tecson</small>
                    </li>
                </ul>
